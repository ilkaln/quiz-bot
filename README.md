...
Реализация Telegram бота на Go для проведения квизов.
-> Загрузка квизов в JSON (настройки + вопросы)
-> Управление лобби участников
-> Параллельное прохождение квиза
-> Экспорт результатов в CSV
-> Повторный запуск ранее созданных квизов
